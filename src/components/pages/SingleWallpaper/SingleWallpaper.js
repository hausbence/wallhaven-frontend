...
const SingleWallpaper = (props) => {
    ...
    const wallpaperUrl = `https://wallhaven.cc/api/v1/w/${[current.match.params.id]}`;
            ...
            <div>
                <SideBar>
                    <IconContainer>
                        ...
                        <a className="link" href="#">Search for similar...</a>
                        <a className="link" href="https://www.artstation.com/artwork/8lvmER" >www.artstation.com</a>
                        <React.Fragment>
                    ...
                    <DropDown>
                        <select id="sources" name='sources' className="custom-select sources">
                            <option value="large" onChange={selectionSetter}>Large</option>
                            <option value="medium" onChange={selectionSetter}>Medium</option>
                            <option value="small" onChange={selectionSetter}>Small</option>
                        </select>
                        <button className={"btn"} onClick={selectionSetter}>submit</button>
                    </DropDown>
                </SideBar>
                <div>
